...
export { extensions, parse, newState, shouldOpenBlock, shouldCloseBlock, forwardToCloser, backToOpener, style, styleBehind, isComment, commentLine };
...
function parse(state, char, { log, row, col }) {
    var _a, _b;
    ...
    if (state.state === 'code') {
        if ((behind(state, 1) === '/') &&
        ...
        else if ((char === '}') && (((_a = last(state)) === null || _a === void 0 ? void 0 : _a.type) === 'backtick')) {
            state.stack.pop();
            ...
            const lastOpener = (_b = last(state)) === null || _b === void 0 ? void 0 : _b.type;
